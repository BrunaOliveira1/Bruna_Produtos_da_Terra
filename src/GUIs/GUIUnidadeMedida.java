...
public class GUIUnidadeMedida extends JDialog {
    ...
    private UnidadeMedidaTableModel tableModel;

    private DAOUnidadeMedida daoUnidadeMedida = new DAOUnidadeMedida();

    ;

    public GUIUnidadeMedida() {

        setTitle("CRUD - UnidadeMedida");
        ...
        tableModel = new UnidadeMedidaTableModel(lista);
...
//        painelBotoes.add(btnRem);
            ...
            public void actionPerformed(ActionEvent evt) {
                if (table.getSelectedRow() >= 0) {
                    ...
                    if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(cp,
                            "Confirme a exclusão [" + tableModel.getValue(table.getSelectedRow()).getIdUnidadeMedida() + " - "
                            + tableModel.getValue(table.getSelectedRow()).getNomeUnidadeMedida() + "]?", "Confirm",
        ...
        btnAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                unidadeMedida.setNomeUnidadeMedida("Nome");

                try {
                    UnidadeMedida c = daoUnidadeMedida.obter(unidadeMedida.getIdUnidadeMedida());
                    if (c == null) {
                        daoUnidadeMedida.inserir(unidadeMedida);
                        tableModel.onAdd(unidadeMedida);
                        tableModel.fireTableDataChanged();
                    } else {
                        JOptionPane.showMessageDialog(cp, "Já existe");
                    }
                } catch (Exception err) {
                    JOptionPane.showMessageDialog(cp, "Erro ao inserir =>" + unidadeMedida.getIdUnidadeMedida()
        ...
        btnRem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (table.getSelectedRow() != -1 && table.getSelectedRow() < tableModel.getRowCount()) {
                    UnidadeMedida c = tableModel.getValue(table.getSelectedRow());
                    daoUnidadeMedida.remover(c);
                    tableModel.onRemove(table.getSelectedRows());

                } else {
                    JOptionPane.showMessageDialog(cp, "Escolha na tabela o unidadeMedida a ser excluído");
                    table.requestFocus();
                }
                tableModel.fireTableDataChanged();
            }
        ...
        btnCarregar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    List<UnidadeMedida> lc = daoUnidadeMedida.list();
    ...
    private static class DateEditor extends AbstractCellEditor implements TableCellEditor {
        ...
        public static void main(String[] args) {
            GUIUnidadeMedida guiUnidadeMedida = new GUIUnidadeMedida();
        }
    }
}
