...
public class GUIItensPK extends JDialog {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (tfIdProduto.getText().equals("")) {
                    ...
                    try {
                        ...
                        itensPK.setVendaIdVenda(Integer.valueOf(tfIdVenda.getText()));
                        itensPK.setCadastroProdutoIdProduto(Integer.valueOf(tfIdProduto.getText()));
                        DAOItens daoItens = new DAOItens();
                        vendaProduto = daoItens.obter(itensPK);

                        if (vendaProduto != null) { //se encontrou na lista                            
                            tfQuantidade.setText(String.valueOf(vendaProduto.getQuantidade()));
                            tfPrecoVenda.setText(String.valueOf(vendaProduto.getPrecoUnitario()));
                        ...
                        labelAviso.setText("Alguns dos campos ID estão vazios - " + x.getMessage());
                    }
                }
            }
        });
...
//-----------------------------  SAVE ------------------------------------------
        btnSave.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    vendaProduto.setItensPK(new ItensPK(idVenda, idProd));
                ...
                try {
                    ...
                    vendaProduto.setPrecoUnitario(Double.valueOf(tfPrecoVenda.getText()));
                    zerarAtributos();
                ...
                if (!deuRuim) {
                    if (acao.equals("insert")) {
                        daoItens.inserir(vendaProduto);
                        labelAviso.setText("Registro inserido.");
                    } else {
                        daoItens.atualizar(vendaProduto);
        ...
        btnList.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                acao = "list";
                GUIItensPKListagem guiItensPKListagem = new GUIItensPKListagem(daoItens.listInOrderNome());
            }
        });
        ...
        btnDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (JOptionPane.YES_OPTION == JOptionPane.showConfirmDialog(null,
                        ...
                        + vendaProduto.getProduto().getNomeProduto() + "\n"
                        + Integer.valueOf(vendaProduto.getItensPK().getVendaIdVenda()) + "\n"
                        + "R$" + vendaProduto.getPrecoUnitario() + "\n",
                        "Confirm",
                        JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE)) {
                    labelAviso.setText("Registro excluído...");
//                    daDoItensPK.remover(produto);
                    daoItens.remover(vendaProduto);
                    zerarAtributos();
                    mostrarBotoes(true);
                    atvBotoes(false, true, false, false);
                    tfIdVenda.requestFocus();
