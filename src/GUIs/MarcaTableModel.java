...
public class MarcaTableModel extends AbstractTableModel {
    ...
    public void onAdd(Marca marcaConta) {
        dados.add(marcaConta);
        fireTableRowsInserted(indexOf(marcaConta), indexOf(marcaConta));
    }
